...
- Are tax_rate values percentage INTEGERS (8, 10, 5) or valid string labels (KCT, KKKNT)? If you see decimals like 0.08 or 0.1, the script must multiply by 100. Non-numeric tax labels should be kept as strings.
