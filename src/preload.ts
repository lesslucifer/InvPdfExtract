...
const api: InvoiceVaultAPI = {
  ...
  reanalyzeFile: (relativePath: string, hint: string) => ipcRenderer.invoke('reanalyze-file', relativePath, hint),
  checkFileHasResults: (relativePath: string) => ipcRenderer.invoke('check-file-has-results', relativePath),
  ...
  openInstructionFile: (file: 'extraction-prompt' | 'je-instructions' | 'config') => ipcRenderer.invoke('open-instruction-file', file),
